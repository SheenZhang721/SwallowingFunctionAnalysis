...
class Temporal_DSCNet(nn.Module):
    def __init__(
        self,
        n_channels,
        n_classes,
        ...
        self.temporal_Trans5 = TemporalTransformer(56, 4 * self.number, patchSize=4)
        self.convFuse5 = EncoderConv(8 * self.number, 4 * self.number)
        self.temporal_Trans7 = TemporalTransformer(28, 8 * self.number, patchSize=2)
